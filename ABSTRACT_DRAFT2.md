# บทคัดย่อและวัตถุประสงค์ (ฉบับปรับปรุงให้ตรงกับผลการทดลองจริง — รอบที่ 1)
...
>
> **เอกสารนี้บันทึกผลการทดลองรอบแรก** (13 เทคนิค classical image preprocessing, ชุดข้อมูลภาพจริง 137 ภาพ, `use_doc_unwarping`/`use_textline_orientation` ปิดอยู่) เก็บไว้เพื่ออ้างอิงวิธีคิดและใช้เปรียบเทียบผลกับรอบถัดไปเท่านั้น **ไม่ใช่ฉบับล่าสุด** — pipeline และตัวเลขที่ใช้อ้างอิงจริงในปัจจุบัน (ชุดข้อมูลภาพจริง 216 ภาพ, engine settings ที่แก้ไขแล้ว, box_thresh=0.30) อยู่ใน [`ABSTRACT_DRAFT.md`](ABSTRACT_DRAFT.md)
